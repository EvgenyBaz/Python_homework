...
stu1.add_exam_result("Математика", 5)
stu1.add_exam_result("Математика", 4)
print(f'Студент {stu1.get_full_name()} имеет среднюю оценку за экзамены по предмету "Математика" = {stu1.get_exam_result("Математика")}')

stu1.add_exam_result("История", 3)
stu1.add_exam_result("История", 4)
print(f'Студент {stu1.get_full_name()} имеет среднюю оценку за экзамены по предмету "История" = {stu1.get_exam_result("История")}')


stu1.add_test_result("Физика", 50)
stu1.add_test_result("Физика", 60)
print(f'Студент {stu1.get_full_name()} имеет среднюю оценку за тесты по предмету "Физика" = {stu1.get_test_result("Физика")}')

print(f'Студент {stu1.get_full_name()} имеет среднюю оценку за все предметы = {stu1.get_total_exam_result()}')
